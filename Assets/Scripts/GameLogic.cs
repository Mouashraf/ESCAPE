...
public class GameLogic : MonoBehaviour
{
	...
	public bool hasShownAlready = false;
	...
	IEnumerator thrownAxe(float number)
	{
		yield return new WaitForSeconds(number);
		Axe.SetActive(true);
		Axe.GetComponent<Rigidbody>().AddForceAtPosition((Vector3.up - Vector3.forward) * 20f, new Vector3(-2.954f, 1.832783f, 19.251f), ForceMode.Impulse);
	}
